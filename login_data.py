...
def collect_login_data(robinhood_obj, username, password, device_token, mfa_code, mfa_required):
    logged_in = False
    while logged_in != True:
        ...
        if logged_in != True and logged_in.get('non_field_errors') == None and mfa_required == True:
            if mfa_code is None:
